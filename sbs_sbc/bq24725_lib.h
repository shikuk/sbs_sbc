/*
   ...
   https://github.com/psas/stm32/blob/master/common/devices/include/BQ24725.h
*/

#ifndef BQ24725_LIB_H_
#define BQ24725_LIB_H_
...
typedef enum {charge_enable = 0, charge_disable = 1} BQ24725_charge_inhibit;
